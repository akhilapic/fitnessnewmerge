					...
					<form name="workout_plan_edit" id="workout_plan_edit" method="post" action="javascript:void(0)" enctype="multipart/form-data">
					    ...
					    <div class="row">
							...
							<div class="mb-3 col-md-3">
								...
								<input type="text" id="arabic_name" name="arabic_name" value="{{$workoutPlans->arabic_name}}" required="true" class="form-control">
							</div>
							<div class="mb-3 col-md-3">
						...
						<div class="mb-3 col-md-4">
							...
							<div class="mb-4 col-md-4">
								<label for="Name" class="control-label"> Arabic Description:</label>
									<textarea class="form-control" rows="5" cols="5" required="true" name="arabic_description" id="arabic_description" >{{$workoutPlans->arabic_description}}</textarea>
							</div>
							<div class="mb-3 col-md-4">
							...
							<div class="mb-3 col-md-12">
								...
								@if($exercise_details)
									...
									@foreach($exercise_details[$key] as $k =>$val)
										...
										<input type="text" name="arabic_excercise_name" id="arabic_excercise_name{{$key+1}}{{$k}}" class="form-control arabic_excercise_name" placeholder="Name Of Arabic Excercise {{$k}}" value="{{$val['arabic_exercise_name']}}">
